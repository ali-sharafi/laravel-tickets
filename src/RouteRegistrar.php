...
class RouteRegistrar
{
    ...
    public function all()
    {
        ...
        $this->router->post('/', 'TicketController@store')->name('tickets.store')->middleware(config('tickets.requests-throttle'));
        ...
        $this->router->group(['prefix' => '{ticket}'], function () {
            ...
            $this->router->post('/message', 'TicketController@message')->name('tickets.message')->middleware(config('tickets.requests-throttle'));
